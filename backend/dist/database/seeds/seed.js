...
async function seed(dataSource) {
    ...
    const categoryRepository = dataSource.getRepository(entities_1.Category);
    const bookRepository = dataSource.getRepository(entities_1.Book);
    const cartRepository = dataSource.getRepository(entities_1.Cart);
    ...
    const books = [
        ...
        },
        {
            ...
            price: 14.99,
            stock: 60,
            description: 'A fantasy adventure following Bilbo Baggins on his quest with dwarves to reclaim their treasure.',
        ...
        },
        {
            ...
            price: 11.99,
            stock: 45,
            description: 'A comedic science fiction series following Arthur Dent through space after Earth is demolished.',
        ...
        },
        {
            ...
            price: 17.99,
            stock: 20,
            description: 'An exploration of cosmology, black holes, and the nature of time and the universe.',
        ...
        },
        {
            ...
            price: 14.99,
            stock: 80,
            description: 'The first book in the Harry Potter series, following a young wizard discovering his magical heritage.',
        ...
        },
        {
            ...
            price: 39.99,
            stock: 18,
            description: 'A guide to becoming a better programmer with practical advice and best practices.',
        ...
        },
        {
            ...
            price: 12.99,
            stock: 50,
            description: 'A classic personal development book on achieving success through positive thinking.',
        ...
        },
        {
            ...
            price: 16.99,
            stock: 35,
            description: 'Notes on startups and how to build the future by creating truly innovative companies.',
